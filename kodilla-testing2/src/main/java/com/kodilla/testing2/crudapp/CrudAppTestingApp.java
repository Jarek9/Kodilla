...
public class CrudAppTestingApp {
    ...
    public static void main(String[] args) {
        ...
        driver.get("https://jarek9.github.io/");


        WebElement searchField = driver.findElement(By.id(XPATH_INPUT ));
        searchField.sendKeys("New robotic task");


        WebElement textareaField = driver.findElement(By.id(XPATH_TEXTAREA ));
        searchField.sendKeys("New robotic content");

        while (!driver.findElement(By.xpath(XPATH_SELECT)).isDisplayed());

        WebElement selectCombo = driver.findElement(By.id(XPATH_SELECT ));
